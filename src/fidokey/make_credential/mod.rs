...
use super::{
    ...
    pin::DEFAULT_PIN_UV_AUTH_PROTOCOL, FidoKeyHid,
};
use crate::{
...
impl FidoKeyHid {
    ...
    pub fn make_credential_with_args(&self, args: &MakeCredentialArgs) -> Result<Attestation> {
        ...
        let send_payload = {
            ...
            // This needs to be reworked to get a proper auth token, or probably an auth token
            // needs to be provided to this function
            // be careful here, moved most to create payload
